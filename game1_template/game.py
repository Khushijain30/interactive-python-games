...
def remove_punct(text):
    ...
    'goSouTh'
    """
    # Remove Punctuations by using Regex
    punctuations = '''!()-[]{};:'"\,<>./?@#$%^&*_~'''
    no_punct_text = ""
    for char in text:
...
def remove_spaces(text):
    ...
    ''
    """
    #Using Regex I removed leading and trailling spaces
    #Beginning spaces
...
def normalise_input(user_input):
    ...
    # I used to two functions remove_punct and remove_spaces to normalise the input
...
def display_room(room):
    ...
    # Displaying Room Information according to the Tests
    print("")
...
def exit_leads_to(exits, direction):
    ...
    # Returning the name of the room where the exit leads to by direction

    exit = exits[direction]
    exit_text = rooms[exit]["name"]
    return exit_text
...
def print_menu_line(direction, leads_to):
    ...
    """
    # Printing menu line according to the test

    direction = direction.upper()
    direction_text = "Go " + direction + " to " + leads_to + "."
...
def print_menu(exits):
    ...
    #Printing menu according to the test
    
    print("You can:")

    # Iterating over available exits:
    #     and for each exit printing the appropriate menu line
  
    for exit in exits:
        leads_to = exit_leads_to(exits,exit)
        print_menu_line(exit,leads_to)
...
def menu(exits):
    ...
    while True:
        ...
        input_value = normalise_input(input_value)

        # Normalise the input
        is_valid = is_valid_exit(exits,input_value)
